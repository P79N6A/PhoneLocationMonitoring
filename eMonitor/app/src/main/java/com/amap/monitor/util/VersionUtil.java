...
import com.amap.monitor.views.CommonProgressDialog;
...
public class VersionUtil {
    ...
    private String apkCacheName = "apk";
    public VersionUtil(Activity context){
        this.mContext = context;
        apkPath = mContext.getExternalCacheDir().getPath()+ File.separator+"app"+File.separator;
    }
    ...
    // 获取更新版本号
    public void getVersion(final int vision,String newversion,String content) {
        ...
        String url = Common.apkurl;//安装包下载地址
    ...
    private void ShowDialog(int vision, String newversion, String content,
                            final String url) {
        new android.app.AlertDialog.Builder(this.mContext)
                .setTitle("版本更新")
                .setMessage(content)
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                ...
                if (Environment.getExternalStorageState().equals(
                    ...
                    file = new File(apkPath+apkCacheName);
...
//                        .send();
    ...
    private void getMultiYes(List<String> grantedPermissions) {
        Toast.makeText(mContext, R.string.message_post_succeed, Toast.LENGTH_SHORT).show();
    }
    ...
    private void getMultiNo(List<String> deniedPermissions) {
        ...
        if (AndPermission.hasAlwaysDeniedPermission(mContext, deniedPermissions)) {
            AndPermission.defaultSettingDialog(mContext, REQUEST_CODE_SETTING)
                    .setTitle(R.string.title_dialog)
    ...
    private void update() {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
                ...
                Uri contentUri = FileProvider.getUriForFile(mContext,"com.skyrin.bingo.fileprovider",apkFile);
